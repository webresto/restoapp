// Vendored from assistant-ui (packages/ui .../tool-fallback.tsx), adapted:
// base-ui data-open/data-closed variants -> radix data-[state=...] (adminizer
// shadcn is radix-based), useScrollLock dropped (needs forwardRef Collapsible).
...
function ToolFallbackResult({
  ...
  return (
    <div data-slot="tool-fallback-result" className={cn('aui-tool-fallback-result', className)} {...props}>
      ...
      <pre className="aui-tool-fallback-result-content bg-muted/50 text-foreground/90 mt-1 max-h-80 overflow-y-auto rounded-md p-2.5 text-xs whitespace-pre-wrap">
  ...
  if (declaredOptions && declaredOptions.length > 0) {
    ...
    return (
      <div
        ...
        className={cn('aui-tool-fallback-approval flex flex-wrap items-center gap-2 pt-1', className)}
        {...props}
      >
