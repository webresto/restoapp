// Vendored from assistant-ui (packages/ui .../markdown-text.tsx).
// The dot.css import moved to globals.css (all CSS is injected by the entry).
import {
...
const defaultComponents = memoizeMarkdownComponents({
  ...
  table: ({ className, ...props }) => (
    <table className={cn('aui-md-table my-3 w-full border-separate border-spacing-0 overflow-y-auto', className)} {...props} />
  ),
  th: ({ className, ...props }) => (
