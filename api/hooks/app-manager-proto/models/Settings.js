// This model was moved into core restoapp
// const moduleHelper_1 = require("../helpers/moduleHelper");
// const settingsHelper_1 = require("../helpers/settingsHelper");
...
//         /**
//          * emitter is not defined in project without core
//          * But we need it here, because this model replace origin model settings in core
//          * */
//         try {
//             //@ts-ignore
...
//         if (!settingsHelper_1.default.isInDeclaredSettings(key) && !Settings.env("ALLOW_UNSAFE_SETTINGS")) {
...
//                     break;
//                 default:
//                     sails.log.error(`Settings set error: Can not calculate type for [${key}] by given value [${settingType}], but type is required fiel!`);
//                     return;
//             }
//         }
//         if (!settingType) {
...
//         }
//         catch (e) {
//             sails.log.error(`MM > Settings > set DB error: key [${key}]`, settingsSetInput, e);
//         }
//     },
//     env(key) {
