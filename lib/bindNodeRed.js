...
// Creates symlinks, removing whatever is already in their place
    ...
    try {
        ...
        files.forEach(file => {
            ...
            try {
                ...
                // No symlink or target there yet — carry on
            }
...
function isNodeRedEnabled() {
  return NodeRedToken.gate().ok;
}
